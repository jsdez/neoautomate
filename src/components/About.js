...
import 'glightbox/dist/css/glightbox.min.css'; // Glightbox for lightbox effect
import '../App.css';
      ...
      <div className="container">
        <div className="row gy-4">
          ...
          <div className="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <img src="assets/img/about.jpg" className="img-fluid rounded-4 mb-4" alt="About Us" />
            <p>
          ...
          {/* Right column with content, list, and video */}
          <div className="col-lg-6" data-aos="fade-up" data-aos-delay="250">
            <div className="content ps-0 ps-lg-5">
              ...
              <div className="position-relative mt-4">
                <img src="assets/img/about-2.jpg" className="img-fluid rounded-4" alt="About Us Video Thumbnail" />
